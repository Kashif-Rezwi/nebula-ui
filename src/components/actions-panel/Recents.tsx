...
export function Recents({
    ...
    // Conversation awaiting delete confirmation. Kept separate from the dialog's
    // open flag so the title doesn't reset while the close animation plays.
    ...
    return (
        <div className="p-4 flex flex-col gap-2">
            ...
            {/* Delete confirmation — actual deletion happens in ActionsPanel via
                the optimistic useDeleteConversation mutation */}
            <ConfirmDialog
