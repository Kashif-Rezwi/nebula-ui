  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onClose}
        className="lg:hidden absolute top-4 right-4 z-10 w-8 h-8 rounded-lg flex items-center justify-center text-foreground/60 hover:text-foreground hover:bg-surface-hover transition-smooth cursor-pointer"
        title="Close menu"
      >
